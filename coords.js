let Alaska = [{ lat: 70.0187, lng: -141.0205 },
...
let Alabama = [{ lat: 35.0041, lng: -88.1955 },
...
let Arkansas = [{ lat: 33.0225, lng: -94.0416 },
...
let Arizona = [{ lat: 36.9993, lng: -112.5989 },
...
let California = [{ lat: 41.9983, lng: -124.4009 },
...
let Delaware = [{ lat: 39.7188, lng: -75.7919 },
...
let Florida = [{ lat: 30.9988, lng: -87.605 },
...
let Georgia = [{ lat: 34.9974, lng: -85.6082 },
...
let Hawaii = [{ lat: 19.5158, lng: -154.6284 },
...
let Iowa = [{ lat: 40.5848, lng: -95.7623 },
...
let Idaho = [{ lat: 49.0, lng: -117.0319 },
...
let Illinois = [{ lat: 42.5116, lng: -90.629 },
...
let Indiana = [{ lat: 41.7611, lng: -87.5253 },
...
let Kansas = [{ lat: 40.0034, lng: -102.0506 },
...
let Kentucky = [{ lat: 36.4986, lng: -89.5372 },
...
let Louisiana = [{ lat: 33.0225, lng: -94.043 },
...
let Massachusetts = [{ lat: 42.0003, lng: -72.7789 },
...
let Maryland = [{ lat: 39.722, lng: -79.4778 },
...
let Maine = [{ lat: 45.3425, lng: -71.0129 },
...
let Michigan = [{ lat: 48.3033, lng: -88.3713 },
...
let Minnesota = [{ lat: 43.5008, lng: -96.4517 },
...
let Missouri = [{ lat: 40.6181, lng: -91.7468 },
...
let Mississippi = [{ lat: 35.0041, lng: -90.3049 },
...
let Montana = [{ lat: 44.475, lng: -111.0512 },
...
let NorthCarolina = [{ lat: 33.7963, lng: -78.485 },
...
let NorthDakota = [{ lat: 48.9955, lng: -104.0501 },
...
let Nebraska = [{ lat: 42.9986, lng: -104.0543 },
...
let NewHampshire = [{ lat: 45.0153, lng: -71.5045 },
...
let NewJersey = [{ lat: 41.3572, lng: -74.695 },
...
let NewMexico = [{ lat: 36.9971, lng: -109.0448 },
...
let Nevada = [{ lat: 41.9922, lng: -120.0037 },
...
let NewYork = [{ lat: 42.5142, lng: -79.7624 },
...
let Ohio = [{ lat: 38.4385, lng: -82.3425 },
...
{ lat: 38.3761, lng: -82.5952 }]
let Oklahoma = [{ lat: 37.0015, lng: -103.0051 },
...
let Oregon = [{ lat: 46.2587, lng: -124.2444 },
...
let Pennsylvania = [{ lat: 42.3261, lng: -80.5174 },
...
let RhodeIsland = [{ lat: 41.3706, lng: -71.0568 },
...
let SouthCarolina = [{ lat: 32.0488, lng: -80.7001 },
...
let SouthDakota = [{ lat: 45.9435, lng: -104.0501 },
...
let Tennessee = [{ lat: 36.6739, lng: -88.0678 },
...
let Texas = [{ lat: 31.8659, lng: -106.5715 },
...
let Utah = [{ lat: 36.9982, lng: -114.0491 },
...
let Virginia = [{ lat: 36.6017, lng: -83.6753 },
...
let Vermont = [{ lat: 45.0104, lng: -73.3427 },
...
let Washington = [{ lat: 49.0023, lng: -123.3208 },
...
let Wisconsin = [{ lat: 42.5116, lng: -90.6303 },
...
let WestVirginia = [{ lat: 39.7188, lng: -79.4765 },
...
let Wyoming = [{ lat: 41.0037, lng: -104.0556 },
